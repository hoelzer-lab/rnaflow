...
process deseq2 {
    ...
    publishDir "${params.output}/${params.dir}", mode: 'copy', pattern: "input.csv"
    ...
    """
    R CMD BATCH '--args c("${params.output}/${params.dir}/") c(${count_files}) c("treat","mock","treat","mock","mock","treat") c(${col_labels}) c("treat","mock") c("mock:treat") c("${ensembl2id}") c("${params.species}") c()' ${script}
    """
}
